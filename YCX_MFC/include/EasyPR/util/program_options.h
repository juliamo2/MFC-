...
namespace program_options
{
	...
	public:
		...
		inline void add_usage_line(const TemplateValue& row) { templates_.push_back(row); }
	...
	private:
		EASYPR_API friend std::ostream& operator<<(std::ostream& out, Subroutine& subroutine);
	...
	class EASYPR_API Parser;
	
	class EASYPR_API Generator
	{
	public:
	...
	class EASYPR_API ParseError : public std::exception
	{
	public:
